...
import mz.co.basse.inbasse.core.exception.PrepaidPaymentCanNotBeCanceledException;
...
//				.findClients(null, null, null, null, true, null, null), client);
		startDate.setValue(mz.co.basse.inbasse.web.util.DateUtils.getPastDate(14));
		endDate.setValue(mz.co.basse.inbasse.web.util.DateUtils.getCurrentDate());
	}
